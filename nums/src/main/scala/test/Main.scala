...
object Main  {
  def main(args:Array[String]){
    ...
    val f = new Font("Serif", Font.PLAIN, 60)
    
    val d = new Display("Font Test")
    val test = new OGLFont(f, d.getSize._1, d.getSize()._2)
    d.setClearColor((0.5f, 0.5f, 0.5f))
    while(!d.shouldClose){
      d.clear()
      test.drawString("Hallo Welt, pustekuchen", new Vec2(0,0), new Vec3(0,0,0))
      d.update()
    }
  //  g.drawStuff()
  }
